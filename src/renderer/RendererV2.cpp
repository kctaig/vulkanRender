...
bool Renderer::initWindow(unsigned int width, unsigned int height) {
    ...
    window_ = glfwCreateWindow(
        ...
        "Vulkan Renderer - Stage 1.5 (Depth + UBO + Mesh Input)",
        nullptr,
        nullptr
    );
...
void Renderer::updateUniformBuffer(std::uint32_t frameIndex, float timeSeconds) {
    ...
    ubo.model = glm::rotate(glm::mat4(1.0f), timeSeconds * glm::radians(25.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    ubo.view = glm::lookAt(glm::vec3(1.8f, 1.6f, 1.8f), glm::vec3(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
